  ...
  Widget _buildProfileHeader() {
    return Column(
      children: [
        ...
        const Text('Owner: Shaidul Islam • Provider ID: P45210',
            style: TextStyle(
                fontFamily: 'Inter',
                fontSize: 13,
          ...
          Row(
            children: [
              Icon(Icons.verified_user_rounded,
                  color: _isVerified ? const Color(0xFF2196F3) : Colors.black38,
                  size: 24),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Expanded(
              child:
                  _buildStatItem('Completed', '124', const Color(0xFF6950F4))),
          Container(width: 1, height: 40, color: Colors.black12),
          Expanded(
              child:
                  _buildStatItem('Active Gigs', '14', const Color(0xFFFF9800))),
          Container(width: 1, height: 40, color: Colors.black12),
          Expanded(
              child:
                  _buildStatItem('Avg Rating', '4.8', const Color(0xFF4CAF50))),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            children: [
              _buildReviewRow(
                  'John Doe', 'Great servicing. Arrived perfectly on time!', 5),
              const Divider(height: 24, color: Colors.black12),
              _buildReviewRow(
                  'Sarah Khan', 'A bit pricey but fixed the TV issues.', 4),
            ],
          ),
        ),
      ],
